...
- AC-7.7 THE content loader SHALL keep the backslash-to-`/` behavior of AC-1.5 unchanged. A unit test tagged `// AC-arch-3.7.7` SHALL pin that a path whose stem contains `\` (for example `a\b`) gets the slug `a/b`.
